...
function render_product($product)
{
    ...
    <div class="product-card col-sm-3 bg-dark rounded p-2">
        ...
        <div class="px-2 pb-2">
            ...
            <hr>
            <div>
                <button class="btn-product btn btn-dark w-100 d-flex justify-content-center align-items-center my-2" onclick="location.href='<?= 'details.php?product_id=' . $product['id']; ?>'">
                ...
                <button class="btn-product btn btn-dark w-100 d-flex justify-content-center align-items-center my-2" <?= $product['quantity_available'] > 0 ? "" : "disabled" ?>>
                    <span class="material-icons-outlined">
